...
const ProductsRow = ({ data, objects }) => {
  ...
  const defaultImage = "https://cdn.grofers.com/app/images/products/sliding_image/406724a.jpg?ts=1624525137";
      ...
      <div className="hidden md:block overflow-x-auto scrollbar-hide">
        <div className="flex space-x-3 pb-2">
          {products.map((product, index) => (
            <div key={index} className="flex-shrink-0 w-32 bg-white rounded-lg border border-gray-200 p-3 relative">
